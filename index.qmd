...
- $MN$ is the matrix normal distribution
  ...
  $$
  	A\sim MN(M,U,V)\Leftrightarrow vec(A)\sim N(vec(M),V\otimes U)
  $$
...
- e.g. a negative (unfavorable) supply shock during COVID-19
  $$
    u_{2020Q1}^S < 0
  $$
